...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-version3 --enable-gpl --enable-nonfree --enable-cross-compile --cc=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --extra-cflags='-fPIC -DANDROID -I/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/include' --enable-armv5te --extra-ldflags='-Wl,-T,/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/lib -L/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/lib -nostdlib /media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o /media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl' --logfile=../configure.log
prefix=/usr/local
...
SRC_PATH="/media/host/_android/github/android-ffmpeg-2/jni/ffmpeg"
SRC_PATH_BARE=/media/host/_android/github/android-ffmpeg-2/jni/ffmpeg
BUILD_ROOT="/media/host/_android/github/android-ffmpeg-2/jni/ffmpeg"
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
AS=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
RANLIB=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -fPIC -DANDROID -I/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/include  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -fPIC -DANDROID -I/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/include  -fPIC -g
CC_O=-o $@
LDFLAGS= -Wl,-T,/media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/lib -L/media/host/android-ndk-r8b-linux/platforms/android-8/arch-arm/usr/lib -nostdlib /media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o /media/host/android-ndk-r8b-linux/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
